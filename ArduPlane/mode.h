...
class ModeRollController : public Mode
{
public:

    Number mode_number() const override { return Number::RollController; }
    const char *name() const override { return "RollController"; }
    const char *name4() const override { return "RLCTRL"; }
